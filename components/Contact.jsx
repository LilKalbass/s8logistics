            ...
            <div className= 'xl:grid xl:grid-cols-3 px-2 xl:px-0'>
                <div className = 'flex flex-col py-10'>
                    ...
                    <div className= 'xl:py-4 py-2 flex flex-row items-center'>
                        ...
                        <a href={`tel:${+380663324759}`} className = 'text-[18px] px-2 mt-0.5 text-grey'>+3790123880924</a>
                    </div>
                    <div className= 'xl:py-4 py-2 flex flex-row items-center'>
                        ...
                        <p className= 'text-[18px] px-2 mt-0.5 text-grey'>abrakadabra_02dabra@gmail<span className = 'text-green'>.</span>com</p>
                    </div>
                    <div className= 'xl:py-4 py-2 flex flex-row items-center'>
                        ...
                        <p className= 'px-2 text-[18px] mt-0.5 text-grey'>Одеса<span className = 'text-green'>,</span> вул<span className = 'text-green'>.</span>ЯкасьТамВулиця 86</p>
                    </div>
                </div>
                <MapContainer
