...
const Hero = () => {
    return (
        <section className= 'md:bg-hero ph:bg-heroph bg-no-repeat xl:bg-cover relative xl:h-[1098px] py-40 pb-32 xl:py-0' id='home'>
            <div className= 'container mx-auto'>
                <div className='flex items-center xl:h-[960px]'>
                    <div className='w-full xl:max-w-[560px] text-center xl:text-left '>
                        <h1 className='text-secondary ph:text-[36px] ph:leading-[52px] ph:mb-4 xl:mb-0 '><span className= 'text-green '>З нами,</span><br/>межі не існують</h1>
                        <p className = 'text-black drop-shadow-2xl font-bold xl:mb-10 mb-8 text-[16px] ph:text-[14px]'>
