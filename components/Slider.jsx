                ...
                return (
                    <SwiperSlide key = {id}>
                        <div className = "flex flex-col justify-between items-center bg-secondary/10 h-[420px] rounded-2xl xl:px-[48px] px-4 py-9 ph:py-4">
                            ...
                            <div className = "flex items-center md:gap-x-1 ph:gap-x-0 flex-col xl:flex-row justify-end gap-y-2">
                                <Image src = {client.image} width = {60} height = {60} alt = "q" className='rounded-full ph:mb-1 md:mr-1'/>
